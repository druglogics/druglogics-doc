...
::: {.tip}
A `globaloutput = 0` refers to a model with **zero cell growth** (cell death state) while a `globaloutput = 1` refers to a model with **maximum growth** (proliferation state).
:::
