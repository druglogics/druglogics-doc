...
R shiny app that was built to use the results from Drabme's [ensemble-wise synergies output file](#drabme-output) and produce a ROC curve in order to assess the performance of Drabme's classification predictor.
- [abmlog](https://github.com/druglogics/abmlog)  
A generator of all possible boolean models with link operators.
- [emba]
